...
class TestPessoa(unittest.TestCase):
    def setUp(self):
        self.p1 = Pessoa('Luke', 'Cage')
        self.p2 = Pessoa('Jessica', 'Jones')
    
    def test_pessoa_attr_nome_tem_o_valor_correto(self):
        self.assertEqual(self.p1.nome, 'Luke')
        self.assertEqual(self.p2.nome, 'Jessica')
    
    def test_pessoa_attr_sobrenome_tem_o_valor_correto(self):
        self.assertEqual(self.p1.sobrenome, 'Cage')
        self.assertEqual(self.p2.sobrenome, 'Jones')
